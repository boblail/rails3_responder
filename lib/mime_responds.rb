require 'corext' # I don't know why this isn't coming from active_support...
require 'responder'
require 'request'


# HACK: built module MimeResponds right into ActionController::Base
...
=end
  ...
  # included (when this was a module)   
